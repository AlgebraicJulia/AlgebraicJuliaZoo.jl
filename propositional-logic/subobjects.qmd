...
```{julia}
to_graphviz(vset_rep, node_labels = true, edge_labels = true, graph_attrs=Dict(:splines=>"false", :rankdir => "LR"))
```
...
```{julia}
to_graphviz(eset_rep, node_labels = true, edge_labels = true, graph_attrs=Dict(:splines=>"false", :rankdir => "LR"))
```
